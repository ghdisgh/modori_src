...
public class BazaarVO {
	...
	public BazaarVO(int num, String name, String img1, String img2, String img3, int stu_seller_num, int stu_buyer_num,
			int price, int sale, int category, String pro_condition, String sell_condition, String deal, String comment,
	...
	public String toString() {
		return "num=" + this.num + ", name=" + this.name + ", img1=" + this.img1 + ", img2=" + this.img2 + ", img3="
				...
				+ ", price=" + this.price + ", sale=" + this.sale + ", category=" + this.category + ", pro_condition="
