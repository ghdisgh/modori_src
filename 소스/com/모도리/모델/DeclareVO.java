...
public class DeclareVO {
	...
	public String toString() {
		return "declare_num=" + this.declare_num + ", declare_stu_num=" + this.declare_stu_num + ", reporter_stu_num="
				+ this.reporter_stu_num + ", declare_pro_name=" + this.declare_pro_name + ", declare_category="
				+ this.declare_category;
	}
}