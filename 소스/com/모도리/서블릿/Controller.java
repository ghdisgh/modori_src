...
public class Controller extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "mainPopUpUI":
			page="mainPopUp.jsp";
			break;
		case "mainPopUpAction":
			a = new MainPopUpAction();
			page = a.execute(request, response);
			break;
		...
		case "declareGroupBuyingEnrollAction":
			...
			page = a.execute(request, response);
			break;
		case "studentAdminAction":
			a = new StudentAdminAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilBazaarEnrollUI":
			page="studentBazaarEnroll.jsp";
			break;
		case "studentCouncilBazaarInfoAction":
			a = new StudentCouncilBazaarInfoAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilBazaarInfoUpdateAction":
			a = new StudentCouncilBazaarInfoUpdateAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilBazaarUpdateAction":
			a = new StudentCouncilBazaarUpdateAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilBazaarEnrollAction":
			a = new StudentCouncilBazaarEnrollAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilBazaarTouchAction":
			a = new StudentCouncilBazaarTouchAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilBazaarAction":
			a = new StudentCouncilBazaarAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilBookCountAction":
			a = new StudentCouncilBookCountAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilBookEnrollCountAction":
			a = new StudentCouncilBookEnrollCountAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilDamageAction":
			a = new StudentCouncilDamageAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilDeleteAction":
			a = new StudentCouncilDeleteAction();
			page = a.execute(request, response);
			break;
		case "studentCouncilSellerMoneyAction":
			a = new StudentCouncilSellerMoneyAction();
			page = a.execute(request, response);
			break;
		case "adminAction":
			a = new AdminAction();
			page = a.execute(request, response);
			break;
		case "productAdminAction":
			a = new ProductAdminAction();
			page = a.execute(request, response);
			break;
		case "productTouchAdminAction":
			a = new ProductTouchAdminAction();
			page = a.execute(request, response);
			break;
		case "declareAdminAction":
			a = new DeclareAdminAction();
			page = a.execute(request, response);
			break;
		case "memberFireAction":
			a = new MemberFireAction();
			page = a.execute(request, response);
			break;
		case "memberFireCancleAction":
			a = new MemberFireCancleAction();
			page = a.execute(request, response);
			break;
		case "declareWithdrawAdminAction":
			a = new DeclareWithdrawAdminAction();
			page = a.execute(request, response);
			break;
		case "memberInfoAction":
			a = new MemberInfoAction();
			page = a.execute(request, response);
			break;
		case "index":
		default:
